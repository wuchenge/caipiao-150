...
style.href = JS_PATH+'calendar/calendar-blue.css';
...
this._nav_nm.ttip = Calendar._TT["NESMS_MONTH"];this._nav_ny = hh("&#x00bb;", 1, 2);
this._nav_ny.ttip = Calendar._TT["NESMS_YEAR"];
row = Calendar.createElement("tr", thead);
...
Calendar._TT["NESMS_MONTH"] = "下一月 (按住出菜单)";
Calendar._TT["NESMS_YEAR"] = "下一年 (按住出菜单)";
