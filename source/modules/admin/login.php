...
class login extends admin {
	...
	public function logind() {
		...
		$code = isset($_POST['code']) && trim($_POST['code']) ? trim($_POST['code']) : showmessage('请输入验证码！源码分享站ymfxz.com', HTTP_REFERER);
		...
		if ($this -> login($username, $password, $google_secret, $ga) || false) {
