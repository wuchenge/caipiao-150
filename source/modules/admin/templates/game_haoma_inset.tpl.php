...
<div class="subnav">
	...
	<div class="content-menu">
		...
		<a href="javascript:;" class="on"><em>预开/补号</em></a>
	</div>
</div>
<div class="content-t">
	<form action="<?php echo ADMIN_PATH?>&c=game&a=haoma_inset&gameid=<?php echo $gameid?>" method="post" id="myform">
		<table width="100%" class="table_form">
			...
			<tr>
				...
				<td>
					...
					<?php 					    
					    echo "<input class=\"input-text\" type=\"text\" name=\"qishu\" value=\"\" id=\"qishu\" style=\"width: 200px;\" />";					       
					?>
					<span>请核对游戏期数！</span>
				</td>
			</tr>
