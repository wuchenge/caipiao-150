...
<div class="content-t">
    ...
    <tr>
      ...
      <td><?php echo $settingarr['stamp'].round($today_profit_count['cash']['money']-$today_profit_count['pay']['money'], 2)?></td>
      <td><?php echo $settingarr['stamp'].round($yesterday_profit_count['cash']['money']-$yesterday_profit_count['pay']['money'], 2)?></td>
      <td><?php echo $settingarr['stamp'].round($tswk_profit_count['cash']['money']-$tswk_profit_count['pay']['money'], 2)?></td>
      <td><?php echo $settingarr['stamp'].round($thismonth_profit_count['cash']['money']-$thismonth_profit_count['pay']['money'], 2)?></td>
      <td><?php echo $settingarr['stamp'].round($lastmonth_profit_count['cash']['money']-$lastmonth_profit_count['pay']['money'], 2)?></td>
      <td><?php echo $settingarr['stamp'].round($quarter_profit_count['cash']['money']-$quarter_profit_count['pay']['money'], 2)?></td>
    </tr>
